...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 11, 2024 at 07:46 PM
...
CREATE TABLE IF NOT EXISTS `customers` (
  ...
  `lead_id` char(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `customer_group` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `invoice_custom_form` (
  ...
  `field_details` text COLLATE utf8mb4_unicode_ci,
  `footer_details` text COLLATE utf8mb4_unicode_ci,
  `total_in_word` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `bank_details` text COLLATE utf8mb4_unicode_ci,
  `issued_by` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `order_info` (
  ...
  `mobile_number` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `area` enum('Inside Dhaka','Outside Dhaka') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `contact_address` text COLLATE utf8mb4_unicode_ci,
  ...
  `status` enum('New','Pending','Processing','Completed','Cancelled') COLLATE utf8mb4_unicode_ci DEFAULT 'New',
...
CREATE TABLE IF NOT EXISTS `product_specification` (
  ...
  `work_order_file` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `work_order_rate` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `purchase_order_value` decimal(15,2) DEFAULT NULL,
  `purchase_order_file` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `amc_start_date` date DEFAULT NULL,
  `amc_renewal_date` date DEFAULT NULL,
  `amc_rate` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `amc_effective_amount` decimal(15,2) DEFAULT NULL,
  `amc_agreement_documents` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `service_type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `software_value` text COLLATE utf8mb4_unicode_ci,
  `hardware_value` text COLLATE utf8mb4_unicode_ci,
  `implementation_value` text COLLATE utf8mb4_unicode_ci,
  `invoice_mushak_file` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tax_exemption_certificate` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1, 'slider one', 'slider-new_1733677874.png', NULL, 1, '2024-12-08 17:11:14', '2024-12-08 17:11:14'),
