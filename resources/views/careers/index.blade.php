    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Careers 
                    <!--begin::Separator-->
                    <span class="h-20px border-gray-200 border-start ms-3 mx-2"></span>
                    <!--end::Separator-->
                    <!--begin::Description-->
                    <small class="text-muted fs-7 fw-bold my-1 ms-1">Show Job List</small>
                    <!--end::Description-->
                </h1>
                <!--end::Title-->
            </div>
            ...
            <div class="d-flex align-items-center py-1">
                ...
                <!--begin::Button-->
                <a href="{{ route('create-career') }}" class="btn btn-sm btn-success" id="kt_toolbar_primary_button">Create a Job Post</a>
                &nbsp;&nbsp;
                ...
                <div class="card mt-3">
                    ...
                    <div class="d-flex justify-content-between align-items-start card-header px-2 border-0 pt-1">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder fs-3 mb-1">Job List</span>
                            <!-- <span class="text-muted mt-1 fw-bold fs-7">Leads Form data here</span> -->
                        </h3>

                        <div class="d-flex align-items-center flex-wrap gap-2">
                            <form action="{{ route('career-search') }}" method="POST" class="d-flex">
                                @csrf
                                <!--begin::Input group-->
                            ...
                            @if($careers->isNotEmpty())
                                ...
                                <table
                                    ...
                                    <tr class="fw-bolder text-muted bg-light bd-cyan">
                                        ...
                                        <th class="min-w-100px">Job Post Image</th>
                                    ...
                                    @foreach ($careers as $career)
                                        <tr>
                                            ...
                                            {{--<td class="text-dark fs-6">{{ $career->career_category->category_name }}</td>
                                            <td class="text-dark fs-6 ">{{ $career->career_description }}</td>--}}

                                            <td style="width: 20%;" class="text-dark fs-6" style="border:1px solid red">
                                                @if($career->job_image != '')
                                                    <img style="width: 35%;" src="{{ asset('uploads/careers/' . $career->job_image) }}" alt="{{ $career->job_title }}">
                                                @endif
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-inline-flex justify-content-end gap-1 w-100 border-bottom-0">
                                                    ...
                                                    <a href="{{ route('career-show', $career->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
