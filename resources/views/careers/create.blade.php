                            ...
                            <div class="card card-xxl-stretch mt-4">
                                <div class="card-header bg-light bd-cyan">
                                    ...
                                    <div class="card-title m-0">
                                        <h3 class="fw-bolder m-0">Create Job Post</h3>
                                    </div>
                                    <!--end::Card title-->
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="g-form w-100" action="{{ route('career-store') }}"  enctype="multipart/form-data" method="POST">
                                         @csrf
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="fv-row mb-3">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input class="form-control form-control-sm form-control-solid" type="text" name="job_title" autocomplete="off"/>
                                                    <!--end::Input-->
                                            ...
                                            <div class="col-md-6">
                                                <div class="fv-row mb-3">
                                                    ...
                                                    <select class=" form-control form-control-sm form-control-solid" name="Career_category_id" aria-label="Default select example">
                                            ...
                                            <div class="col-md-6">
                                                <div class="fv-row mb-3">
                                                    <label class="form-label  fw-bolder text-dark">Upload Job Post Image</label>
                                           ...
                                           <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="form-label fw-bolder text-dark" for="textarea">Job Description</label>
                                                    <textarea class="form-control form-control-sm editor form-control-solid" name="job_description" rows="3"></textarea>
