            ...
            <div class="row align-items-center">
               <div class="col-xl-7 col-lg-12 col-md-12 col-12">
                  <div class="tp-breadcrumb">
                     ...
                     <h2 class="tp-breadcrumb__title">Blog Page</h2>
                  </div>
               </div>
            </div>
         </div>
                     ...
                     <article class="postbox__item format-image mb-60 transition-3">
                        <div class="postbox__thumb w-img mb-25">
                           <a href="{{ route('blog-details', $blog->id) }}">
                              <img src="{{url('/')}}/uploads/blogs/{{$blog->blog_image}}" alt="blog-thumg">
                           </a>
                        </div>
                        <div class="postbox__content">
                           <div class="postbox__meta mb-15">
                              <!-- <span><a href="#"><i class="fal fa-user-alt"></i> Alextina</a></span> -->
                              <span><i class="fal fa-clock"></i> {{ date('d M Y', strtotime($blog->created_at)) }}</span>
                           ...
                           <div class="postbox__text mb-30">
                              {!! substr($blog->blog_description, 0, 300) !!} ..........
                           </div>
                           <div class="postbox__read-more">
                              <a href="{{ route('blog-details', $blog->id) }}" class="tp-btn tp-color-btn banner-animation">Reade More</a>                               
                           </div>
                        </div>
                     </article>
                    @endforeach
                     ...
                     <div class="basic-pagination">
                        <nav>
                           @include('components.front_pagination', ['paginator' => $blogs])
                         </nav>
                     </div>
                  </div>
               </div>
