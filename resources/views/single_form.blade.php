                        ...
                        <div class="col-xxl-12">
                            <div class="card card-xxl-stretch">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="g-form w-100" action="#">
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label fw-bolder text-dark" for="textarea">Textarea</label>
                                                    <textarea class="form-control form-control-lg  form-control-solid" name="textarea" rows="3"></textarea>
                                                </div>
                                            </div>
