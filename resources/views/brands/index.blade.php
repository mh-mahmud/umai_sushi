    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Brands
                    <!--begin::Separator-->
                    <span class="h-20px border-gray-200 border-start ms-3 mx-2"></span>
                    <!--end::Separator-->
                    <!--begin::Description-->
                    <small class="text-muted fs-7 fw-bold my-1 ms-1">Show Brand List</small>
                    <!--end::Description--></h1>
                <!--end::Title-->
            </div>
            <!--end::Page title-->
            ...
            <div class="d-flex align-items-center py-1">
                ...
                <!--begin::Button-->
                <a href="{{ route('brand-create') }}" class="btn btn-sm btn-primary" id="kt_toolbar_primary_button">Create</a>
                ...
                <div class="card mt-4">
                    ...
                    <div class="d-flex justify-content-between align-items-start card-header border-0 p-1">
                        <h3 class="card-title align-items-start flex-column">
                            ...
                            <!-- <span class="text-muted mt-1 fw-bold fs-7">brand data here</span> -->
                        </h3>

                        <div class="d-flex flex-wrap gap-2">
                            <form action="{{ route('brand-search') }}" method="POST" class="d-flex">
                                @csrf
                                <!--begin::Input group-->
							...
							<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
								...
								<path
                                    ...
                                    <input type="text" name="search"
                                           ...
                                           value="{{ request('search') }}" placeholder="Search by brand title or description">
                                </div>
                                <!--end::Input group-->
                            ...
                            @if($brands->isNotEmpty())
                                ...
                                <table
                                    ...
                                    <tr class="fw-bolder text-muted bg-light bd-cyan">
                                        ...
                                        <th class="min-w-140px">Brand Image</th>
                                    ...
                                    @foreach ($brands as $brand)
                                        <tr>
							                ...
							                <td class="ps-5 text-dark fs-6">{{($brands->currentPage() - 1) * $brands->perPage() + $loop->iteration}}</td>
                                            <td class="text-dark fs-6">{{$brand->brand_name}}</td>
                                            <td class="text-dark fs-6 w-200px">{{$brand->brand_image }}</td>
                                            <td class="text-dark fs-6 w-200px">{{$brand->brand_description }}</td>
                                            <td>
                                                @if ($brand->status == 1)
